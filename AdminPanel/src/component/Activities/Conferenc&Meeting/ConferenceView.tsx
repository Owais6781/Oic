...
const ConferenceView: React.FC = () => {
    ...
    useEffect(() => {
        ...
        axios.get(`${API}/activitiesConference/${id}`)
            .then((res) => {
    ...
    const handleDelete = async () => {
        ...
        try {
            await axios.delete(`${API}/activitiesConference/${id}`)
    ...
    return (
        <div className="max-w-3xl mx-auto p-8 bg-white shadow-xl rounded-xl mt-10 space-y-6">
            ...
            <h2 className="text-3xl font-bold text-center">Conference & Meeting View </h2>
