...
if (documentFile) {
    ...
    // });
     ...
     await axios.post(`${API}/legal`, FD, {
    headers: { "Content-Type": "multipart/form-data" }
  });

    alert("legal Added Successfully!");
    navigate("/legalTable");


  }

 const categories = ["OIC Human Rights Related Instruments and Texts",
         "Basic International Human Rights Instruments and Declarations"];
