...
const AboutMemberTable: React.FC = () => {
  ...
  // Filtered data based on search and selected category
      ...
      <div className="w-full max-w-5xl bg-white shadow-xl rounded-2xl p-6">
        ...
        <div className="flex justify-between items-center mb-6">
          ...
          <button
            ...
            onClick={() => navigate("/aboutMemberForm")}
          >
            Create
          </button>
        </div>
                  ...
                  >
                    ...
                    <td className="py-3 px-4 text-center">
                      <button
                        ...
                        onClick={() => navigate(`/aboutMemberView/${item._id}`)}
                      >
                    ...
                    <td className="py-3 px-4 text-center">
                      <button
                        ...
                        onClick={() =>
                          navigate(`/aboutMemberEdit/${item._id}`)
                        }
                      >
...
export default AboutMemberTable;
